    ...
    <div v-else>
      <div>
        <div class="d-flex justify-content-center">
          <div
            class="card my-5"
            style="border-radius: 12px; box-shadow: 0.1px 4px 7px #00000047"
          >
            <div class="card-header bg-transparent text-center title-car">
              Meu carrinho
            </div>
            <div class="card-body">
              <div
                v-for="item in this.params.products.store"
                :key="item.id"
                class="mb-4 d-flex flex-row flex-wrap"
              >
                <div>
                  <img
                    class="carrinho-img--style"
                    :src="item.imageUrl"
                    alt=""
                  />
                </div>
                <div class="carrinho-text--style">
                  ...
                  <p style="color: #c9dada; font-size: 14px">
            ...
            <div class="card-body d-flex flex-column align-items-center">
              ...
              <p
                v-if="this.params.products.total * -1 > 10"
                class="my-3 alerta alert-success text-center"
